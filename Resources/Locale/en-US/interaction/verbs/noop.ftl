...
interaction-CheckOut-success-self-popup = Your eyeballs violate {THE($target)}.
interaction-CheckOut-success-target-popup = You think that {THE($user)} might be looking at yo dih...
